...
/**
 * Cliente de API completo para Acbr Api.
 *
 * Este arquivo contém a classe `AcbrApi` que implementa todas as chamadas
 * para os endpoints da API, usando a interface AcbrApiHttpClient.
 *
 * Pré-requisito: o arquivo `acbr-api.types.ts` com todas as interfaces
...
import { AcbrApiHttpClient } from "../types/acbr-api-api.httpclient";
import {
  ConsultarCepResult,
  ListarCnpjResult,
  ConsultarCnpjResult,
...
} from "../types/acbr-api-interfaces";
import {
  ConsultarCepParams,
  ListarCnpjQuery,
  ConsultarCnpjParams,
  ...
  BaixarXmlNfseParams,
  BaixarXmlDpsParams,
} from "../types/acbr-api-payloads";

export class AcbrApi {
  constructor(private http: AcbrApiHttpClient, private baseUrl: string) {}
