// src/types/acbr-api-api.interfaces.ts

// Generated from nfce-types-full.ts — interface-friendly format
// Do not edit manually; update nfce-types-full.ts instead if needed.
...
export interface Empresa {
  ...
  /**
   * Format: date-time
   * @description Data/hora em que o objeto foi criado na Acbr Api. Representado no formato <a href="https://en.wikipedia.org/wiki/ISO_8601" target="blank">`ISO 8601`</a>.
   *
   * A Acbr Api gerencia esse campo automaticamente. Caso algum valor seja enviado, ele será ignorado*.
   */
  created_at?: string;
  /**
   * Format: date-time
   * @description Data e hora que o objeto foi alterado pela última vez na Acbr Api. Representado no formato <a href="https://en.wikipedia.org/wiki/ISO_8601" target="blank">`ISO 8601`</a>.
   *
   * A Acbr Api gerencia esse campo automaticamente. Caso algum valor seja enviado, ele será ignorado*.
   */
  updated_at?: string;
...
export interface EmpresaConfigNfseRegTrib {
   ...
   *    convertido internamente pela Acbr Api para o código correspondente
...
export interface EmpresaConfigRps {
   ...
   * Informe o próximo número do lote RPS a ser utilizado. Após isso, a Acbr
   * Api gerenciará esse campo (a cada novo envio de lote o número é
   ...
   * Informe o próximo número de RPS a ser utilizado. Após isso, a Acbr
   * Api gerenciará esse campo (a cada novo envio de RPS o número é
   * incrementado em + 1). Portanto, basta informá-lo no cadastro da empresa
   * uma única vez.
   */
  numero: number;
...
export interface EmpresaConfigDistribuicaoNfe {
   ...
   *
   * Quando ativada, a API da Acbr Api realizará automaticamente pedidos de
   ...
   *
   * Esse valor determina com que frequência a API da Acbr Api executará novas
...
export interface Dfe {
  /** @description ID único gerado pela Acbr Api para este documento. */
  id?: string;
  /** @enum {string} */
  ambiente?: "homologacao" | "producao";
  /**
   * Format: date-time
   * @description Data/hora em que o documento foi criado na Acbr Api. Representado no formato <a href="https://en.wikipedia.org/wiki/ISO_8601" target="blank">`ISO 8601`</a>.
   */
  created_at?: string;
  /**
   * @description * `pendente`: o pedido de emissão do documento foi recebido pela Acbr Api e está na fila de processamento.
   ...
   * `erro`: status próprio da Acbr Api que significa, na maioria das vezes, que houve algum erro que impediu a transmissão do documento para a SEFAZ (erros de validação, erros interno do servidor, timeouts, etc).
   * @enum {string}
   */
  status?:
    | "pendente"
...
export interface DfeAutorizacao {
  ...
  digest_value?: string;
  /** @description ID único gerado pela Acbr Api para este evento. */
  id?: string;
  /**
   * @description Identificação do ambiente.
   * @enum {string}
...
export interface NfseCidadesAtendidas {
  /** @description Quantidade de cidades atendidas pela Acbr Api. */
  "@count"?: number;
  /** @description Lista com os códigos IBGE das cidades atendidas pela Acbr Api. */
  "data"?: string[];
}
...
export interface RpsPedidoEmissaoLote {
  /**
   * @description Identificação do Ambiente.
   * @enum {string}
   */
...
export interface RpsPedidoEmissao {
   ...
   * Caso não informado, será considerada a data/hora da requisição à API da Acbr Api.
   */
  data_emissao?: string;
  /**
   * Format: date-time
   * @description Competência do RPS, no formato AAAA-MM-DD.
   * Caso não informado, será considerada a data da requisição à API da Acbr Api.
   */
  competencia?: string;
  /**
...
export interface RpsIdentificacaoPrestador {
  /**
...
export interface RpsLote {
  /** @description ID único do lote gerado automaticamente pela Acbr Api. */
  id?: string;
  /** Format: date-time */
  created_at?: string;
  /** @enum {string} */
...
export interface Nfse {
  /** @description ID único da nota gerado automaticamente pela Acbr Api. */
  id?: string;
  /** Format: date-time */
  created_at?: string;
  /** @enum {string} */
...
export interface NfseCancelamento {
  /** @description ID único do cancelamento gerado automaticamente pela Acbr Api. */
  id?: string;
  /** @enum {string} */
...
export interface RegTrib {
   ...
   *   da NFS-e, sem qualquer conversão pela Acbr Api.
   ...
   *   prefeitura, sem depender da lógica de conversão automática da Acbr Api.
   *
...
export interface EmailListagem {
  "@count"?: number;
  "data"?: EmailResumo[];
}
...
export interface EmailResumo {
  /**
   * @description ID único gerado pela Acbr Api para este email.
   *
...
export interface DistribuicaoNfe {
  /** @description ID único gerado pela Acbr Api para o pedido de distribuição. */
  id: string;
  /**
   * Format: date-time
   * @description Data/hora em que o pedido foi criado na Acbr Api. Representado no formato <a href="https://en.wikipedia.org/wiki/ISO_8601" target="blank">`ISO 8601`</a>.
   */
  created_at?: string;
  /**
...
export interface DistribuicaoNfeDocumento {
  /** @description ID único gerado pela Acbr Api para identificar o documento. */
  id: string;
  /**
   * Format: date-time
   * @description Data/hora em que o documento foi criado na Acbr Api. Representado no formato <a href="https://en.wikipedia.org/wiki/ISO_8601" target="blank">`ISO 8601`</a>.
...
export interface DistribuicaoNfeEvento {
  ...
  /**
   * Format: date-time
   * @description Data/hora em que o evento foi criado na Acbr Api. Representado no formato <a href="https://en.wikipedia.org/wiki/ISO_8601" target="blank">`ISO 8601`</a>.
   */
  created_at?: string;
  /**
   * @description Identificação do ambiente.
...
export interface CnpjPorteEmpresa {
...
export interface CnpjFaixaEtaria {
