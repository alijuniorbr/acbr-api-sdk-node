// src/types/acbr-api-payloads.ts

import * as Defs from "./acbr-api-interfaces-definitions";
...
export type ConsultarEventoCteParams = {
  ...
  /** ID único do evento gerado pela Acbr Api. */
  id: string;
};
...
export type ConsultarCteParams = {
  ...
  /** ID único do CT-e gerado pela Acbr Api. */
  id: string;
};
...
export type BaixarXmlCteConhecimentoParams = {
  ...
  /** ID único da CT-e gerado pela Acbr Api. */
  id: string;
};
...
export type ConsultarCteOsParams = {
  ...
  /** ID único do CT-e OS gerado pela Acbr Api. */
  id: string;
};
...
export type BaixarXmlCteOsConhecimentoParams = {
  ...
  /** ID único da CT-e OS gerado pela Acbr Api. */
  id: string;
};
...
export type ConsultarDceParams = {
  ...
  /** ID único da DC-e gerada pela Acbr Api. */
  id: string;
};
...
export type BaixarPdfDceParams = {
  ...
  /** ID único da DC-e gerado pela Acbr Api. */
  id: string;
};
...
export type DebugDfeParams = {
  ...
  /** ID único do documento fiscal gerado pela Acbr Api. */
  id: string;
};

export type DebugDfeOriginalPayloadParams = {

  /** ID do documento fiscal gerado pela Acbr Api. */
  id: string;
};
...
export type ConsultarDocumentoDistribuicaoNfeParams = {
  ...
  /** ID único do documento gerado pela Acbr Api. */
  id: string;
};
...
export type ConsultarManifestacaoNfeParams = {
  ...
  /** ID único da manifestação gerado pela Acbr Api. */
  id: string;
};
...
export type ConsultarDistribuicaoNfeParams = {
  ...
  /** ID único da distribuição de NF-e gerada pela Acbr Api. */
  id: string;
};
...
export type ConsultarEmailParams = {
   ...
   * API da Acbr Api que realize disparos de email.
   *
   * Exemplos:
...
export type ConsultarLoteMdfeParams = {
  ...
  /** ID único do lote gerado pela Acbr Api. */
  id: string;
};
...
export type ConsultarMdfeParams = {
  ...
  /** ID único do MDF-e gerado pela Acbr Api. */
  id: string;
};
...
export type BaixarXmlMdfeManifestoParams = {
  ...
  /** ID único da MDF-e gerado pela Acbr Api. */
  id: string;
};
...
export type ListarEventosNfceQuery = {
  ...
  /** Inclui no JSON de resposta, na propriedade `@count`, o número total de registros que o filtro retornaria, independente dos filtros de paginação. */
  $inlinecount?: boolean;
  /** ID único gerado pela Acbr Api para o documento fiscal. */
  dfe_id: string;
};
...
export type ConsultarNfceParams = {
  ...
  /** ID único da NFC-e gerado pela Acbr Api. */
  id: string;
};
...
export type ConsultarNfcomParams = {
  ...
  /** ID único da NFCom gerada pela Acbr Api. */
  id: string;
};
...
export type BaixarPdfNfcomParams = {
  ...
  /** ID único da NFCom gerado pela Acbr Api. */
  id: string;
};
...
export type ConsultarNfeParams = {
  ...
  /** ID único da NF-e gerado pela Acbr Api. */
  id: string;
};
...
export type BaixarXmlCancelamentoNfseParams = {
  ...
  /** ID único da NFS-e gerado pela Acbr Api. */
  Id: string;
};
